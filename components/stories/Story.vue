<template lang="pug">
a.story(:href="link(story)",target="_new",v-in-viewport,:class="`viewport-delay-${index}`").viewport-slide-y
  .story_image
    img(:src="thumbnail(story)")
  .story_header
    .story_header_label.uppercase.text-sm featured
    .story_header_title.text-xl {{ story.title }}
