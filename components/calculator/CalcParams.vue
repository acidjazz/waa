<template lang="pug">
OffsetSection
  .font-os.mb-4 ACTIVITY
  .text-3xl.mb-8.w-full.lg_w-1_2 Fill out a few parameters below and see the results.
  .flex.flex-col.w-full.lg_w-128.mx-auto
    ...
    .flex.items-center.mb-2.cursor-pointer(@click="by = 'national'")
